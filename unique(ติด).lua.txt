...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Layton Hub Premium Scripts") then
			makefolder("Layton Hub Premium Scripts")
		end
		if not isfolder("Layton Hub Premium Scripts/Blox Fruits/") then
			makefolder("Layton Hub Premium Scripts/Blox Fruits/")
		end
		if not isfile("Layton Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("Layton Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("Layton Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("Layton Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			writefile("Layton Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Undetected Executor")
	end
...
Circle.Color =  Color3.fromRGB(255, 204, 204)
Circle.Thickness = 1
Circle.Radius = 250
Circle.NumSides = 460
Circle.Filled = false
	...
	callback = function(value)
		...
		for k,v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy"..v,true) == 1 then 
				...
				huhu.Image = "rbxassetid://11667490949"
...
function WebHookLog:WebHookKaiTanSend(WebHookUrl)
	...
	local Embeds = {{
		["title"] = "**Layton Hub Webhooks Status**",
